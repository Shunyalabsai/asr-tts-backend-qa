...
- Name: schema-validation/response-schema.spec.ts >> M10-T06: No unexpected extra fields beyond the schema
- Location: src/features/schema-validation/response-schema.spec.ts:176:5
