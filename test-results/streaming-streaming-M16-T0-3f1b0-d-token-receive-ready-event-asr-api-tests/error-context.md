...
- Name: streaming/streaming.spec.ts >> M16-T01: Connect with valid token, receive ready event
- Location: src/features/streaming/streaming.spec.ts:24:5

# Error details

```
Error: Timeout waiting for ready event
```
