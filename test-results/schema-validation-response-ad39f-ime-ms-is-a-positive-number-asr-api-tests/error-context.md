...
- Name: schema-validation/response-schema.spec.ts >> M10-T04: inference_time_ms is a positive number
- Location: src/features/schema-validation/response-schema.spec.ts:122:5
