...
- Name: transcription/response-format.spec.ts >> M05-T01: Default response_format returns json with only text field @smoke
- Location: src/features/transcription/response-format.spec.ts:18:5
